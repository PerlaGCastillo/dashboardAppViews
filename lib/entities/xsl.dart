...
class xlsConverter extends StatelessWidget {
  const xlsConverter({super.key});
...
Widget _createExcel {
  Future<void> _createExcel() async {
    ...
    //Set the text value.
    sheet.getRangeByName('A1').setText("hola soy una pruebas");
...
/*
//https://www.geeksforgeeks.org/flutter-create-an-excel-sheet-and-save-the-file-in-device/
...
final List<int> bytes = workbook.saveAsStream();
FileStorage.weriteCounter(bytes, "reporte.xlsx", context);

final xcel.Workbook workbook = xcel.Workboos();
final xcel.Worksheet sheet = workbook.worksheets[0]

sheet.getRangeByIndex(1,1), setText("Titulo");
final xcel.Workbook sheet = workbook.worksheets[0];

//workbook.dispose();

sheet.getRangeByIndex(1,1).setText("{text}");
sheet.getRangeByIndex(1,2).setText("link");

floatingActionButtonLocation:
  FloationgActionButtonLocation.miniCenterFloat,
floatingActionButton: FloatingActionButton.extend(
onPressed: (){},
label: const Text("Crear documento Excel"),
),
