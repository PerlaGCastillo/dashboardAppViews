...
class VinculadosCapacitacion extends StatefulWidget {
  @override
  _VinculadosCapacitacionState createState() => _VinculadosCapacitacionState();
}

class _VinculadosCapacitacionState extends State<VinculadosCapacitacion> {
