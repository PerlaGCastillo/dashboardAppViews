...
class PorMesPagado extends StatefulWidget {
  @override
  _PorMesPagadoState createState() => _PorMesPagadoState();
}

class _PorMesPagadoState extends State<PorMesPagado> {
  ...
  final _subbject = BehaviorSubject<String>();

  @override
  void initState() {
    super.initState();
    _subbject.add(_controller.text);
  ...
  Stream<List?> _getStream() {
    return _subbject.transform(new StreamTransformer<String, List?>.fromHandlers(
