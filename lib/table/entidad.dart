...
class PorEntidad extends StatefulWidget {
  @override
  _PorEntidadState createState() => _PorEntidadState();
}

class _PorEntidadState extends State<PorEntidad> {
  ...
  final _subjeect = BehaviorSubject<String>();

  @override
  void initState() {
    super.initState();
    _subjeect.add(_controller.text);
  ...
  Stream<List?> _getStream() {
    return _subjeect.transform(new StreamTransformer<String, List?>.fromHandlers(
